"""
Execute Migration V4 automatically with password from environment or command line
"""
import sys
import os
import psycopg2
...
def main():
    ...
    password = sys.argv[1] if len(sys.argv) > 1 else os.environ.get('SUPABASE_DB_PASSWORD')
    
    if not password:
        print("❌ Error: Password required")
        print("Usage: python run_migration_v4_auto.py <password>")
